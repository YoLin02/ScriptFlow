...
export const SHORTCUT_DEFINITIONS: ShortcutDefinition[] = [
  ...
  { id: 'canvas.toggleMediaLibrary', category: '底部菜单栏', label: '打开/关闭配图库', defaultBinding: 'Ctrl+6' },
  { id: 'canvas.toggleMoreTools', category: '底部菜单栏', label: '打开/关闭更多工具', defaultBinding: 'Ctrl+7' },
  ...
  { id: 'editor.extractSelection', category: '脚本区', label: '从选区生成切片', defaultBinding: 'Ctrl+Shift+C' },
