      ...
      <div className="flex min-h-0 flex-1 p-3 pt-1" onDoubleClick={() => setIsEditing(true)}>
        {isEditing ? (
          <textarea
            ...
            className="nodrag h-full min-h-[80px] w-full resize-none text-xs font-sans text-neutral-700 bg-white border border-neutral-200 p-2 rounded focus:outline-none focus:border-neutral-400"
            onClick={(e) => e.stopPropagation()}
            placeholder="写下你的灵感火花..."
          />
        ) : (
          <p className="h-full w-full overflow-auto text-xs font-sans text-neutral-600 italic bg-white/40 p-2.5 rounded border border-neutral-100">
